...
It also allows you to select between several different modes:
 ...
 2. eco mode: minimizes carbon footprint
 3. budget mode: minimizes energy expenditure (if you only have one type of heating or cooling this is the same as eco mode)
